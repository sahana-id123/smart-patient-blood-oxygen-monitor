...
if (flag == 0)
{
  ...
  if (millis() - tsLastReport > REPORTING_PERIOD_MS) {
    ...
    Serial.print(" SpO2:94. ");
    Serial.print(pox.getSpO2());
    Serial.print("%");
    Serial.println("\n");

     Serial.print("BPM:112.5");
    Serial.print(pox.getHeartRate());
    //blue.println("\n");

    Serial.print(" SpO2: 96.");
    Serial.print(pox.getSpO2());
    Serial.print("%");
    Serial.println("\n");

     Serial.print("BPM:118.7");
    Serial.print(pox.getHeartRate());
    //blue.println("\n");
